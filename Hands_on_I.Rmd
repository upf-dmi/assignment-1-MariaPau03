...
Exploratory data analysis was performed to describe the demographic and clinical characteristics of the study population. Sex, age and BMI distributions were first explored using descriptive statistics and graphical representations. Age and BMI showed reasonable ranges without evident implausible values. A correlation analysis was conducted on clinical laboratory markers to identify redundant variables and underlying biological patterns. This analysis revealed a near-perfect positive correlation between total and direct bilirubin (r=0.98), suggesting significant data redundancy. Furthermore, moderate-to-strong positive correlations were observed between liver enzymes ALT and AST (r=0.65), while systemic inflammation (measured by CRP) showed a positive association with AST (r=0.56) and a negative association with lymphocyte counts (r=−0.30), consistent with typical COVID-19 inflammatory signatures.

Some clinical time variables, such as time from symptom onset to hospital admission and time from admission to severe disease, were only defined for subsets of COVID-19 patients, reflecting the study design rather than random missingness. Group comparisons suggested differences in age distributions across COVID-19 severity groups, while BMI appeared broadly similar between groups. Sex distribution varied across clinical groups, with a higher proportion of males observed among COVID-19 patients. Time from symptom onset to admission was explored only among COVID-19 patients and appeared to differ between non-severe and severe cases.

Overall, no major data quality issues were identified, though the CRP variable required type conversion to numeric for analysis, and the dataset was considered suitable for further analysis.
